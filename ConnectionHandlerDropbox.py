...
class ConnectionHandlerDropbox(ConnectionHandler.ConnectionHandler):
    ...
    def create_folders(self):
        ...
        for folder in BUILD_PATHS:
            dbx_folder_list.append(folder)
        for folder in ALIGN_PATHS:
            dbx_folder_list.append(folder)
        for folder in CONV_PATHS:
            dbx_folder_list.append(folder)
        return self.dropbox.files_create_folder_batch(paths=dbx_folder_list)
